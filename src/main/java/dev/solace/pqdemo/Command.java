...
public enum Command {
	...
	KEYS(1, "Pub", "Number of keys available (per-publisher)", "pq-demo/control-all/keys/1000, pq-demo/control-all/keys/max", "'max', or integer [1..2147483647]", Integer.class, 16, 1, Integer.MAX_VALUE),
	...
	DELAY(1, "Pub", "Mean time in ms (scaled Poisson dist) to delay follow-on message", "pq-demo/control-all/delay/2000", "integer [0..30000]", Integer.class, 1000, 0, 30_000),
	...
	public static void main(String... args) {
		...
		System.out.println("Use per-client topic with \"-name\" for individual control: 'pq-demo/control-MDwh0VxT7E/slow/10'");
